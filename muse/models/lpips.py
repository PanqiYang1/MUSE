...
class LPIPS(nn.Module):
    """Learned Perceptual Image Patch Similarity using VGG16."""
    ...
    def load_pretrained(self):
        ...
        VGG_PATH = get_ckpt_path(
            "vgg_lpips",
            os.path.join(workspace, "models/vgg_lpips.pth"),
            check=True
        )
    ...
    def forward(self, input, target):
        ...
        Args:
            input: Images in [0, 1] range [B, 3, H, W].
            target: Images in [0, 1] range [B, 3, H, W].
